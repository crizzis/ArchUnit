 ...
 */
package com.tngtech.archunit.junit.internal.filtering.surefire;

import java.lang.reflect.Field;
import java.util.Objects;
import java.util.Optional;

import com.tngtech.archunit.junit.internal.filtering.AbstractTestNameFilter;
import com.tngtech.archunit.junit.internal.filtering.TestSelectorFactory;
...
public class SurefireTestNameFilter extends AbstractTestNameFilter {
    ...
    @Override
    protected Optional<PostDiscoveryFilter> initialize(PostDiscoveryFilter filter) throws NoSuchFieldException, IllegalAccessException {
